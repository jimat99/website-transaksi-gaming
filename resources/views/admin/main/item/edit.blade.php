        ...
        <div class="card">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between">
                    ...
                    <a href="{{route('item.index')}}" class="btn btn-outline-success btn-sm"><i class="bi bi-arrow-left"></i> Back</a>
                </div>
            <div class="card-body p-5">
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" required name="" placeholder="Item Name">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Item Desc"></textarea>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" required name="" placeholder="Price">
                    </div>
