...
<div class="container-fluid mt--6">
    <form action="{{ route('admin.item.update', ['id' => $item->id_item]) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="card">
            ...
            <div class="card-body p-5">
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" name="nama" required placeholder="Item Name" value="{{ $item->nama }}">
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <textarea class="form-control" id="exampleFormControlTextarea1" name="deskripsi" rows="3" placeholder="Item Desc">{{ $item->deskripsi }}</textarea>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <input type="number" class="form-control" name="harga" required placeholder="Price" value="{{ $item->harga }}">
                    </div>
